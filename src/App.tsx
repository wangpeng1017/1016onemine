...
import BlendingPlan from './pages/IntelligentOreBlending/BlendingPlan';
import IntelligentBlending from './pages/IntelligentOreBlending/IntelligentBlending';
        ...
        <Router>
          <div className="App">
            <Routes>
              ...
              <Route path="intelligent-ore-blending/plan" element={<BlendingPlan />} />
              <Route path="intelligent-ore-blending/intelligent" element={<IntelligentBlending />} />
